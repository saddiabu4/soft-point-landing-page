        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="font-bold text-xl tracking-tight text-slate-800">SOFT POINT</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-500 font-medium">
              <li><a href="#" className="hover:text-emerald-400 transition-colors">Behance</a></li>
              <li><a href="#" className="hover:text-emerald-400 transition-colors">Dribbble</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-500 font-medium">
              <li><a href="#" className="hover:text-emerald-400 transition-colors">Conditions</a></li>
              <li><a href="#" className="hover:text-emerald-400 transition-colors">Privacy and policy</a></li>
            </ul>
          </div>
